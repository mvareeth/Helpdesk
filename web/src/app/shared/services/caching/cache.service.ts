// https://www.npmjs.com/package/ng2-cache - This is the right one, we can take code from this and make it ours.
// https://www.npmjs.com/package/angular2-cache
// code is taken from ng2-cache
...
export class CacheService {
    ...
    private _toStorageOptions(options: CacheOptionsInterface): CacheOptionsInterface {
        let storageOptions: CacheOptionsInterface = {};
